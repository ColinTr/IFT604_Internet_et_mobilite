                ...
                KOBOARD.createPutAxiosRequest("kourses", idListeKourses, {
                  ...
                  .catch((err) => {
                    if (
                      ...
                      SwalHelper.createPleaseReconnectLargePopUp(
                        err.response.data
                      );
                    } else {
                      SwalHelper.createNoConnectionSmallPopUp(
    ...
    return (
      <MDBContainer fluid>
        ...
        <MDBContainer style={{ alignContent: "center", alignItems: "center" }}>
          <MDBRow>
            {this.state.listListKoursesData.map(function (
              listeKoursesData,
              index
            ) {
              return (
                  ...
                  <MDBCard>
                    <div style={{ paddingBottom: "10px" }}>
                      <button
                        className="noteCross"
                        onClick={() =>
                          that.deleteListKourses(listeKoursesData._id)
                        }
                      >
                      ...
                      <button
                        ...
                        onClick={() => {
                          that.editListKourses(
                            listeKoursesData._id,
                            listeKoursesData.title
                          );
                        }}
                      >
                    ...
                    <MDBCardBody>
                      ...
                      <div>
                        <MDBListGroup>
                          {listeKoursesData.elements.map(function (
                            koursesData
                          ) {
                            return (
                              <MDBListGroupItem
                              ...
                              >
                                ...
                                >
                                  <button
                                    ...
                                    onClick={() => {
                                      that.deleteElementOfListKourses(
                                        listeKoursesData._id,
                                        koursesData._id
                                      );
                                    }}
