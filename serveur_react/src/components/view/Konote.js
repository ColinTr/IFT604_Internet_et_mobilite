...
class Konote extends React.Component {
  constructor(props) {
    ...
    this.handleChangeNewNote = this.handleChangeNewNote.bind(this);
  ...
  updateKonotes() {
    ...
    KOBOARD.createGetAxiosRequest("konotes")
      .then((dataNotes) => {
        KOBOARD.createGetAxiosRequest("users").then((dataUsers) => {
  ...
  createKonote() {
    ...
    KOBOARD.createPostAxiosRequest("konotes", {
      ...
      content: that.state.newNoteText,
      ...
      <MDBContainer fluid>
        ...
        <MDBModal isOpen={that.state.modal} toggle={that.toggle}>
          ...
          <MDBModalFooter>
            ...
            <MDBBtn color="primary" onClick={that.createKonote}>
              Ajouter
            </MDBBtn>
          </MDBModalFooter>
        </MDBModal>
